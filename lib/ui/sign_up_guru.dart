...
class _SignUpGuruState extends State<SignUpGuru> {
  ...
  final _kodeGuruController = TextEditingController();
  ...
  Future<void> _register() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        await _authService.registerGuru(
        ...
        if (mounted) {
          Navigator.pushReplacementNamed(context, '/loginguru');
        }
      } catch (e) {
        if (mounted) {
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Tolong isi kode guru';
                    }
                    if (value != "54321") {
                      return 'Kode guru tidak sesuai';
                    }
                    return null;
                  },
                ),
